...
<body>
    ...
    <div class="breadcrumb-section"
        style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url(assets/img/home1/old-dubai-banner.webp);">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/old1.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/old1.1.webp"><i
                                            class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/old2.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/old2.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/old3.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/old3.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/old4.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/old4.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/old5.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/old5.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    ...
                    Old Dubai, also known as the historic district, is a charming area that provides a glimpse into the city's rich cultural heritage and trading history. Here's a description of what you can expect to find in Old Dubai:

                    </p>
                    <p> <strong>Al Fahidi Historical Neighbourhood: </strong>This is one of the oldest residential areas in Dubai, characterized by narrow lanes, traditional wind-tower architecture, and courtyard houses built from coral and gypsum. It offers a stark contrast to the modern skyscrapers of downtown Dubai. Visitors can explore the labyrinthine alleyways and discover hidden gems like art galleries, museums, cafes, and boutique hotels.</p>

                    <p> <strong>Dubai Creek:</strong>The historic heart of Dubai, Dubai Creek is a natural saltwater inlet that divides the city into two parts: Bur Dubai to the west and Deira to the east. The creek was historically vital for trade, serving as a hub for pearl diving, fishing, and shipping activities. Visitors can take a traditional abra (water taxi) ride across the creek to experience the bustling waterfront and admire iconic landmarks such as the Al Fahidi Fort and the Spice and Gold Souks.</p>
