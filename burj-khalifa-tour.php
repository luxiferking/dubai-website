...
<body>
    ...
    <div class="breadcrumb-section"
        style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url(assets/img/home1/burj-khalifa-banner.webp);">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/burja1.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/burja1.1.webp"><i
                                            class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/burja2.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/burja2.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/burja3.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/burja3.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/burja4.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/burja4.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/burja5.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/burja5.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    ...
                    The Burj Khalifa is an iconic skyscraper that stands as the centerpiece of the modern Dubai skyline and holds the title of the world's tallest building. Here's a description of this architectural marvel:

                    </p>
                    <p> <strong>Towering Height: </strong>Reaching a staggering height of 828 meters (2,717 feet), the Burj Khalifa dominates the Dubai skyline with its sleek and futuristic design. It consists of 163 floors above ground, along with additional levels below ground.</p>

                    <p> <strong>Architectural Design:</strong>Designed by the renowned architect Adrian Smith of Skidmore, Owings & Merrill, the Burj Khalifa features a distinctive stepped design that tapers as it rises, resembling a shimmering silver needle piercing the sky. The exterior is clad in reflective glass panels that mirror the surrounding cityscape.</p>
