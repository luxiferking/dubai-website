...
<body>
    ...
    <div class="breadcrumb-section"
        style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url(assets/img/home1/desert-banner.webp);">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/dsafari1.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/dsafari1..1.webp"><i
                                            class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/dsafari2.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/dsafari2.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/dsafari3.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/dsafari3.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/dsafari4.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/dsafari4.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/dsafari5.webp" alt>
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/home1/dsafari5.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    ...
                    <p>A desert safari is an exhilarating adventure experience typically found in regions with expansive desert landscapes like the Arabian Peninsula or the Sahara Desert. It usually involves a guided tour through the desert, often in specialized 4x4 vehicles like Land Rovers or dune buggies.
                    </p>
                    <p> <strong> Dune Bashing:</strong>thrilling ride through the desert dunes in a 4x4 vehicle. Skilled drivers navigate the sandy terrain, providing passengers with an adrenaline-pumping experience as they traverse steep slopes and sharp turns.</p>

                    <p> <strong> Camel Riding:</strong>A chance to experience traditional desert transportation. Riding atop a camel allows participants to leisurely explore the desert landscape while connecting with the ancient nomadic way of life.</p>
