...
<body>
    ...
    <div class="breadcrumb-section"
        style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url(assets/img/home1/spicemarketbanner.webp);">
        <div class="container">
            <div class="row">
    ...
    <div class="destination-details-wrap mb-120 pt-120">
        <div class="container">
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-8">
                    <h2>Welcome To Spice Market</h2>
                    <p>The Spice Market, also known as the Spice Souk, is a vibrant and aromatic marketplace located in
                        the heart of Old Dubai along the bustling Dubai Creek. Stepping into the Spice Market is like
                        entering a fragrant oasis where the air is filled with the rich aromas of exotic spices, herbs,
                        and incense.
                        Visitors to the Spice Market are greeted by a kaleidoscope of colors and textures as they wander
                        through narrow alleyways lined with shops overflowing with sacks and bins of spices from around
                        the world. From the earthy scent of cumin and turmeric to the sweet aroma of cinnamon and
                        cardamom, the Spice Market offers a sensory feast for spice enthusiasts and culinary adventurers
                        alike.
                    </p>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-4 col-sm-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/spice1.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/spice1.1.webp"><i
                                            class="bi bi-eye"></i> Discover Island</a>
                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/spice2.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/spice2.1.webp"><i
                                            class="bi bi-eye"></i> Discover Island</a>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/spice3.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/spice3.1.webp"><i
                                            class="bi bi-eye"></i> Discover Island</a>
                                </div>
                            </div>
                            <!-- <div class="col-lg-3 col-sm-6">
                    ...
                    <p>In addition to spices, the market also boasts an array of dried fruits, nuts, traditional
                        perfumes, and incense, creating a captivating tapestry of flavors and scents that reflect the
                        region's rich cultural heritage and trading history.

                        The Spice Market is not just a place to shop; it's a cultural experience where visitors can
                        immerse themselves in the sights, sounds, and smells of traditional Arabian markets. Friendly
                        vendors are always ready to offer samples and share their knowledge of spices, making every
                        visit a memorable and educational journey into the world of spice trading.
                    </p>
