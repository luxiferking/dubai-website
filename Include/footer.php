                ...
                <div class="row g-lg-4 gy-5 justify-content-center">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-widget">
                            <!-- <div class="footer-logo">
                                <a href="index.php"><img src="assets/img/logo-real.png" alt></a>
                            </div> -->
                            <h3>Want <span>to Take <br></span> Tour Packages<span>?</span></h3>
                                <a href="contact.php" class="primary-btn1">Book A Tour</a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-sm-start">
                        <div class="footer-widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="spice-market.php">Our Package</a></li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-md-start">
                        <div class="footer-widget">
                            <div class="single-contact mb-30">
                                ...
                                <a href="tel:+971561329067">+971561329067</a>
                            </div>
                            <div class="single-contact mb-35">
                                ...
                                <a
                                    href="xpresstourism24@gmail.com"><span
                                        class="__cf_email__"
                            ...
                            <div class="single-contact">
                                ...
                                <a
                                    href="#">Near Dafza metro station Dubai UAE.</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-end justify-content-sm-end">
                        <div class="footer-widget">
                            ...
                            <p>"We Are Here for Unveiling Dubai's Wonders in a Flash"</p>
            ...
            <div class="footer-bottom">  
                <div class="row">
                    ...
                    <div
                        ...
                        <p>©Copyright 2024 Xpress Tourism | Design By <a href="#">Ashish Singh</a></p>
...
chatbotId: "noV3IJvkUGUY3_dOC1Lzs",
...
<script>
  window.botpressWebChat.init({
      ...
      "botId": "b3ba741b-9dd1-4873-8d24-51b89f4fc8db",
      "hostUrl": "https://cdn.botpress.cloud/webchat/v1",
      "messagingUrl": "https://messaging.botpress.cloud",
      "clientId": "b3ba741b-9dd1-4873-8d24-51b89f4fc8db",
      "webhookId": "4651e64a-dfa5-493f-b0c1-47a80a3c5fa9",
      "lazySocket": true,
      "themeName": "prism",
      "frontendVersion": "v1",
      "showPoweredBy": true,
