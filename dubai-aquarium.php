...
<body>
    ...
    <div class="breadcrumb-section"
        style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url(assets/img/home1/aquarium-banner.webp);">
        <div class="container">
            <div class="row">
    ...
    <div class="destination-details-wrap mb-120 pt-120">
        <div class="container">
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-8">
                    <h2>Welcome To Dubai Aquarium</h2>
                    <p>
                        The Dubai Frame is an iconic architectural landmark located in Dubai, United Arab Emirates. It
                        is a towering structure that stands at 150 meters tall and 93 meters wide, resembling a giant
                        picture frame. Situated in Zabeel Park, the Dubai Frame offers breathtaking panoramic views of
                        the city's skyline from its observation decks.

                        The structure consists of two vertical towers connected by a sky bridge at the top, forming the
                        shape of a frame. Visitors can access the bridge, which features a glass-floored walkway,
                        providing a thrilling experience and unparalleled views of both old and new Dubai.

                        One side of the Dubai Frame offers views of the historic neighborhoods and landmarks of old
                        Dubai, including the Al Fahidi Fort and the Dubai Creek, while the other side showcases the
                        modern skyscrapers and landmarks of new Dubai, such as the Burj Khalifa and Dubai Marina.
                        ...
                        <div class="row g-4">
                            <div class="col-lg-4 col-sm-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/aquarium1.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/aquarium1.1.webp"><i
                            ...
                            <div class="col-lg-5 col-sm-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/aquarium2.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/aquarium2.1.webp"><i
                                            class="bi bi-eye"></i> Discover Island</a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/aquarium3.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/aquarium3.1.webp"><i
                                            class="bi bi-eye"></i> Discover Island</a>
                                </div>
                            </div>
                    ...
                    <h2>The Iconic Dubai Frame</h2>
                    <p>The Iconic Dubai Frame stands as a towering symbol of modernity and innovation in the heart of
                        Dubai, United Arab Emirates. This architectural marvel, reaching 150 meters in height and 93
                        meters in width, captivates visitors with its striking design, resembling a colossal picture
                        frame framing the city's skyline.

                        Situated within Zabeel Park, the Dubai Frame offers visitors an extraordinary experience,
                        blending breathtaking views with immersive exhibits that showcase the city's rich heritage and
                        ambitious future.
                    </p>
