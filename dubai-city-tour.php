...
<body>
    ...
    <div class="breadcrumb-section"
        style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url(assets/img/home1/city-tour-banner.webp);">
        <div class="container">
            <div class="row">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="assets/img/home1/ctour1.webp" alt>
                                    <a data-fancybox="gallery-01" href="assets/img/home1/ctour1.1.webp"><i
                                            class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/ctour2.webp" alt>
                                            <a data-fancybox="gallery-01" href="assets/img/home1/ctour2.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/ctour3.webp" alt>
                                            <a data-fancybox="gallery-01" href="assets/img/home1/ctour3.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/ctour4.webp" alt>
                                            <a data-fancybox="gallery-01" href="assets/img/home1/ctour4.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="assets/img/home1/ctour5.webp" alt>
                                            <a data-fancybox="gallery-01" href="assets/img/home1/ctour5.1.webp"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    ...
                    <p>
                        ...
                        A Dubai city tour offers a fascinating glimpse into the dynamic blend of modernity and tradition
                        that characterizes this vibrant metropolis in the United Arab Emirates (UAE). Here's what you
                        might experience on a typical Dubai city tour:


                    </p>
                    <p> <strong>Burj Khalifa: </strong>The tour often begins with a visit to the Burj Khalifa, the
                        world's tallest building. Visitors can marvel at the breathtaking views of the city skyline and
                        beyond from the observation decks located on the upper floors.</p>

                    <p> <strong>Dubai Mall: </strong>Adjacent to the Burj Khalifa is the Dubai Mall, one of the largest
                        shopping and entertainment destinations in the world. Tourists can explore its vast array of
                        shops, restaurants, and attractions, including the Dubai Aquarium and Underwater Zoo.</p>
